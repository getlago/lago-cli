...
- `lago init --insecure` announces that `insecure = true` is persisted in the profile and how to clear it. A re-init without the flag keeps the stored value instead of silently clearing it.
