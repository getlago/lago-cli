## lago subscriptions get-subscription-charge
...
```
lago subscriptions get-subscription-charge <external_id> <charge_code> [flags]
```

### Examples

```
  lago subscriptions get-subscription-charge <external_id> <charge_code>
```

### Options

```
  -h, --help                         help for get-subscription-charge
