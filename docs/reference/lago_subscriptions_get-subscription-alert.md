## lago subscriptions get-subscription-alert
...
```
lago subscriptions get-subscription-alert <external_id> <code> [flags]
```

### Examples

```
  lago subscriptions get-subscription-alert <external_id> <code>
```

### Options

```
  -h, --help                         help for get-subscription-alert
