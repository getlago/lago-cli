...
```
lago billable-metrics create [flags]
```

### Examples

```
  lago billable-metrics create --input @payload.json
  lago billable-metrics create --input @payload.json --output json  # full resource
```
