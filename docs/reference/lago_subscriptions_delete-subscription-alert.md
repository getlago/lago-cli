## lago subscriptions delete-subscription-alert
...
```
lago subscriptions delete-subscription-alert <external_id> <code> [flags]
```

### Examples

```
  lago subscriptions delete-subscription-alert <external_id> <code>
  lago subscriptions delete-subscription-alert <external_id> <code> --output json  # full resource
```

### Options

```
  -h, --help                         help for delete-subscription-alert
